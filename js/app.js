(() => {
    ...
    (() => {
        ...
        function rangeInit() {
            const priceSlider = document.querySelector("#range-price");
            const lengthSlider = document.querySelector("#range-length");
            if (priceSlider) {
        ...
        function initSliders() {
            if (document.querySelector(".stages__slider")) new core(".stages__slider", {
                ...
                loop: true,
                pagination: {
                    el: ".slider-slide__fraction",
                    clickable: true,
                    type: "fraction"
                },
                navigation: {
                    prevEl: ".stages__slider .swiper-button-prev",
                    nextEl: ".stages__slider .swiper-button-next"
                },
                on: {}
            });
            if (document.querySelector(".articles__slider")) new core(".articles__slider", {
                ...
                loop: true,
                pagination: {
                    el: ".articles .slider-slide__fraction",
                    clickable: true,
                    type: "fraction"
                },
                navigation: {
            ...
            if (document.querySelector(".moreblock__slider")) new core(".moreblock__slider", {
                modules: [ Navigation, Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 1,
                ...
                loop: true,
                pagination: {
                    el: ".moreblock__slider .slider-slide__fraction",
                    clickable: true,
                    type: "fraction"
                },
                navigation: {
                    prevEl: ".moreblock__slider .swiper-button-prev",
                    nextEl: ".moreblock__slider .swiper-button-next"
                },
                on: {}
            });
            if (document.querySelector(".card__slider-thumbs")) {
                const thumbsSwiper = new core(".card__slider-thumbs", {
                    modules: [ Navigation, Pagination, Thumb, Grid ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                    spaceBetween: 13,
                ...
                new core(".card__slider", {
                    ...
                    pagination: {
                        el: ".card__slider .slider-slide__fraction",
                        clickable: true,
                        type: "fraction"
                    },
                    navigation: {
            ...
            if (document.querySelector(".photos__slider")) new core(".photos__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
...
***************************************************************************** */
        ...
        if (window.innerWidth > 768 && isMobile.any()) document.addEventListener("click", (function(e) {
            const targetElement = e.target;
            if (targetElement.classList.contains("menu__item-svg")) targetElement.closest(".menu__item").classList.toggle("_arrow-active");
            if (!targetElement.closest(".menu__item") && document.querySelectorAll(".menu__item._arrow-active").length > 0) script_removeClasses(document.querySelectorAll(".menu__item._arrow-active"), "_arrow-active");
        }));
        function script_removeClasses(array, className) {
            for (var i = 0; i < array.length; i++) array[i].classList.remove(className);
        }
        if (document.querySelector(".filter-header__icon")) document.addEventListener("click", (function(e) {
            if (e.target.closest(".filter-header__icon")) {
                document.documentElement.classList.add("filter-open");
                document.documentElement.classList.add("lock");
            }
        }));
        if (document.querySelector(".navigation-filter__icon")) document.addEventListener("click", (function(e) {
            if (e.target.closest(".navigation-filter__icon")) {
                document.documentElement.classList.remove("filter-open");
                document.documentElement.classList.remove("lock");
            }
        }));
        if (document.querySelector(".search-header__icon")) document.addEventListener("click", (function(e) {
            if (e.target.closest(".search-header__icon")) {
                const searchBlock = document.querySelector(".inner-header__search");
